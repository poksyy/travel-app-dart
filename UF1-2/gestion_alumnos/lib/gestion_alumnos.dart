...
List<Module> generateRandomModules() {
  ...
  // using 'rng' from 'math', we specify that the random number must be between 0 and 5, but with '+1' it will always be greater than 0. This random number will be used for the number of modules for each student.
  int numberOfModules = rng.nextInt(5) + 1;
